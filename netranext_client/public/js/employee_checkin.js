frappe.ui.form.on('Employee Checkin', {
    refresh: function(frm) {
        ...
        if (frm.doc.photo_proof) {
            var $photo_wrapper = frm.get_field('photo_proof').$wrapper;
            ...
            var img_url = frm.doc.photo_proof;
            var custom_html = 
            ...
            var $container = $photo_wrapper.find('.control-input-wrapper');
